...
loadinggif.setAttribute("style", "margin-left:-50px;position:fixed;margin-right:auto;margin-top:-50px;top:50%;");
container.setAttribute("style", "margin-left:-390px;left:50%;margin-top:-150px;height:300px;width:780px;top:"+((window.innerHeight>300)?window.innerHeight/2:150)+"px;z-index:9001;background-color:rgba(200,200,200,0.8);position:absolute;text-align:center;");
...
xhr.onreadystatechange = function(){
    if (xhr.readyState==4 && (xhr.status==0 || xhr.status==200)){
        ...
        for (i=0; i<max; i++){
            ...
            dd.onclick = function(){
                location.href = results[i].viewItemURL[0];
            }
